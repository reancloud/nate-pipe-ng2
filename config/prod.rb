...
set :myvpc_deploy_config do
  {
    ...
    deployment_description: 'myvpc - production'
  }
end
...
set :mydb_deploy_config do
  {
    ...
    deployment_description: 'mydb - production'
  }
end
...
#    from a file named testplan/prod/app/myvpc/expected.json
...
#    from a file named testplan/prod/app/myvpc/resource_ids.json
#  - Instead, you can dynamically assign the expected value JSON by uncommenting the line below
#    and populating the ruby hash.
#  - Optionally, you can also explicitly supply a file name using the configuration setting below,
#    by replacing the ruby hash with a string.
...
# set :myvpc_infratest_name, 'prod-nate-pipe-ng2-myvpc'

# OPTIONAL:  You can dynamically declare infratest expected value JSON for the mydb sub-project.
#
#  - By default, HCAP DevSecOps will automatically try to load your expected value JSON
#    from a file named testplan/prod/app/mydb/expected.json
#  - Instead, you can dynamically assign the expected value JSON by uncommenting the line below
#    and populating the ruby hash.
#  - Optionally, you can also explicitly supply a file name using the configuration setting below,
#    by replacing the ruby hash with a string.
...
#    automatically retrieve resource ID JSON from your HCAP Deploy layer.
#  - Otherwise, HCAP DevSecOps will automatically try to load your resource ID JSON
#    from a file named testplan/prod/app/mydb/resource_ids.json
#  - Instead, you can dynamically assign the expected value JSON by uncommenting the line below
#    and populating the ruby hash.
#  - Optionally, you can also explicitly supply a file name using the configuration setting below,
#    by replacing the ruby hash with a string.
...
#
#  - By default, HCAP DevSecOps will use a job name of "prod-[PROJECTNAME]-[LAYERNAME]"
# set :mydb_infratest_name, 'prod-nate-pipe-ng2-mydb'
...
#    automatically retrieve resource ID JSON from your HCAP Deploy layer.
#  - Otherwise, HCAP DevSecOps will automatically try to load your resource ID JSON
#    from a file named testplan/prod/app/myapp/resource_ids.json
#  - Instead, you can dynamically assign the expected value JSON by uncommenting the line below
#    and populating the ruby hash.
#  - Optionally, you can also explicitly supply a file name using the configuration setting below,
#    by replacing the ruby hash with a string.
...
#
#  - By default, HCAP DevSecOps will use a job name of "prod-[PROJECTNAME]-[LAYERNAME]"
# set :myapp_infratest_name, 'prod-nate-pipe-ng2-myapp'
...
# You can disable load, functional, security and URL tests in your environments.
#   Uncomment the corresponding set command below to disable the tests.
#   The actual tests are configured in your project's config.rb.
  
# Disable the load tests (automatically set for the production environment)
set :skip_load_tests, true

# Disable the functional tests
# set :skip_functional_tests, true

# Disable the security tests
# set :skip_security_tests, true

# Disable the URL tests
# set :url_tests, []
